...
namespace Senparc.Weixin.Cache.Redis
{
    ...
    public class RedisManager
    {
        ...
        /// Redis授权密码字符串
        /// </summary>
        public static string ConfigurationPassWord { get; set; }
        ...
        private static ConnectionMultiplexer GetManager(string connectionString = null)
        {
            if (string.IsNullOrEmpty(connectionString))
            {
                ...
                {
                    var options = ConfigurationOptions.Parse(ConfigurationOption);
                    if (ConfigurationPassWord != null)
                    {
                        options.Password = ConfigurationPassWord;
                    }
