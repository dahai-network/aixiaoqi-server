...
namespace Unitoys.Core
{
    ...
    {
        #region 私有成员
        private string dataPath = IOHelper.GetMapPath(@"/App_Data/qqwry.dat");
        private string ip;
        ...
        public static string IPLocation()
        {
            ...
            ipScanner.QQwry();
            return ipScanner.country + ipScanner.local;
        }
        /// <summary>
        /// 获取国家+详细地址
        /// </summary>
        ...
        /// <param name="ip"></param>
        /// <returns></returns>
        public static string IPCountry(string ip)
        {
            IPScanner ipScanner = new IPScanner();
            ipScanner.ip = ip;
            ipScanner.QQwry();
            return ipScanner.country;
        }
        /// <summary>
        /// 获取详细地名。不包括国家
        /// </summary>
