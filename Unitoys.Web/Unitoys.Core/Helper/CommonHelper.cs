...
namespace Unitoys.Core
{
    ...
    public class CommonHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static string RandomLoginToken()
        {
            Random rd = new Random();
            return SecureHelper.MD5(rd.Next(10000).ToString() + DateTime.Now).ToLower();
        }
        /// <summary>
        /// 生成6位的随机数
        /// </summary>
        ...
        /// <returns></returns>
        public static string PayStatusTips(int PayType)
        {
            string paymsg = "";
            switch (PayType)
            {
