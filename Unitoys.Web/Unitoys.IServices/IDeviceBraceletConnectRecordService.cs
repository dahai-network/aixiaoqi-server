...
namespace Unitoys.IServices
{
    public interface IDeviceBraceletConnectRecordService : IBaseService<UT_DeviceBraceletConnectRecord>
    {
        ...
        /// <returns></returns>
        Task<KeyValuePair<int, List<UT_DeviceBraceletConnectRecord>>> SearchAsync(int page, int rows, string iMEI, string tel, int? createStartDate, int? createEndDate, bool? isOnLine);
    }
}
