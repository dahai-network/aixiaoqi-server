...
namespace Unitoys.IServices
{
    public interface IOrderService : IBaseService<UT_Order>
    {
        ...
        Task<KeyValuePair<string, KeyValuePair<int, UT_Order>>> AddOrder(Guid userId, Guid packageId, int quantity, PaymentMethodType PaymentMethod, decimal MonthPackageFee, Guid? PackageAttributeId);
