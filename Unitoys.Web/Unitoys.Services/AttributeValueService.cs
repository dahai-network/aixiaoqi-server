...
{
    public class AttributeValueService : BaseService<UT_AttributeValue>, IAttributeValueService
    {
        //public async Task<KeyValuePair<int, List<UT_AttributeValue>>> SearchAsync(int page, int rows, string tel)
        //{
        //    using (UnitoysEntities db = new UnitoysEntities())
        //    {
        //        var query = db.UT_AttributeValue.Include(x => x.UT_Users).Where(x => true);
        ...
        //        return new KeyValuePair<int, List<UT_AttributeValue>>(count, result);
        //    }
        //}
    }
}
